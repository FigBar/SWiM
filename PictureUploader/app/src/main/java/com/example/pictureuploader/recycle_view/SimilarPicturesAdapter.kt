...
class SimilarPicturesAdapter (private val dataSet: MutableList<PictureRecord>) :
RecyclerView.Adapter<SimilarPicturesAdapter.SimilarPicturesViewHolder>(){
    ...
    class SimilarPicturesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            pictureDisplay = itemView.findViewById(R.id.similar_photo_display)
        }
    }
}